...
<body class="bg-white">
    <nav class="absolute top-0 left-0 w-full z-20 flex justify-between items-center px-10 py-6 text-white">
            ...
            <div class="hidden md:flex items-center gap-10 text-gray-400 font-medium text-sm">
                ...
                <a href="/proyek" class="text-white relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-1/2 after:h-0.5 after:bg-white">Portofolio</a>
